      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-primary-foreground">
        <div className="max-w-4xl mx-auto animate-fade-up">
          <h1 className="font-playfair text-5xl md:text-7xl font-bold mb-6 drop-shadow-lg">
            Maa Samaleswari Restaurant
          </h1>
          <p className="text-xl md:text-2xl mb-4 font-light opacity-95">
            Where Tradition Meets Taste
          </p>
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Experience the authentic flavors of Odia and Indian cuisine in a warm, welcoming atmosphere. 
